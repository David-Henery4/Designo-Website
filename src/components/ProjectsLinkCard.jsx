...
const ProjectsLinkCard = ({title,link,bgImage}) => {
  ...
  return (
    <div className={`relative w-full h-60 font-medium rounded-2xl overflow-hidden flex flex-col justify-center items-center gap-3  bg-no-repeat bg-cover bg-top xsm:h-52 xsm:bg-left ${mob} ${tab} ${desk}`}>
