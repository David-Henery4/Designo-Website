...
const Header = () => {
  return (
    <header className="w-full text-center bg-peach text-white col-start-1 col-end-13">
      {/* TEXT */}
      <div className="px-6 pt-20 flex flex-col justify-center items-center gap-4">
        <h1 className="text-head1Mob leading-9 font-medium">
          Award-winning custom designs and digital branding solutions
        </h1>
        <div className="grid justify-items-center gap-6">
          <p className="text-bodyMob font-light leading-bodyMob">
